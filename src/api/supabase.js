...
export const moviesApi = {
  ...
  getAll: async (page = 0, pageSize = 20, statusId = null) => {
    ...
    let query = `movies?select=id,title,year,poster_path,status_id,rating,director,genres,status!inner(description)&order=updated_at.desc`;
...
export const seriesApi = {
  ...
  getAll: async (page = 0, pageSize = 20, statusId = null) => {
    ...
    let query = `series?select=id,title,year,poster_path,status_id,rating,genres,total_seasons,current_season,status!inner(description)&order=updated_at.desc`;
